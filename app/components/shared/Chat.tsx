  ...
  return (
    <MainContainer className="flex max-h-[550px] min-w-[100%] flex-col overflow-scroll rounded-md">
      ...
      <div className="fixed bottom-4 left-0 right-0 m-auto w-[82%]">
        <textarea
          className="placeholder:text-sm  w-[100%] rounded-md p-1 pl-1 font-mono placeholder:pl-2 placeholder:pt-1 placeholder:text-slate-600 focus:border-transparent focus:ring-black/30 dark:bg-slate-700 dark:text-slate-200"
          value={codeSentence}
