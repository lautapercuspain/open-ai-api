    ...
    return (
        <Transition appear show={isOpen} as={Fragment}>
            ...
            >
                ...
                <div className={`${popins.variable} fixed inset-0 overflow-y-auto font-popins`}>
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >
                            <Dialog.Panel
                                className={
                                    "transform overflow-hidden rounded-2xl bg-purple-400 p-4 text-left shadow-xl transition-all lg:w-[504.01px] lg:h-[487px] md:w-90 md:h-full"
                                }
                            >
                                <div className="flex flex-col content-center justify-start justify-items-start gap-4 p-12">
                                    <Dialog.Title
                                        as="h1"
                                        className="text-left leading-6 text-white text-3xl font-poppins"
                                    >
                                        Add Payment
                                    </Dialog.Title>
                                    <Dialog.Title
                                        as="h1"
                                        className={`font-mono text-2xl leading-10 text-gray-200`}
                                    >
