        ...
        <div className="mx-auto max-w-max pb-10">
          ...
          <div className="mx-auto mt-14 w-[80%]">
            <p className="p-4 text-white">
              ...
              website, and gathering demographic information. Advertising
              Partners Privacy Policies You may consult this list to find the
              Privacy Policy for each of the advertising partners of Code
              Genius. Third-party ad servers or ad networks uses technologies
              like cookies, JavaScript, or Web Beacons that are used in their
              respective advertisements and links that appear on Code Genius,
              which are sent directly to users' browser. They automatically
              receive your IP address when this occurs. These technologies are
              used to measure the effectiveness of their advertising campaigns
              and/or to personalize the advertising content that you see on
              websites that you visit. Note that Code Genius has no access to or
              control over these cookies that are used by third-party
              advertisers. Third Party Privacy Policies Code Genius's Privacy
              ...
              found at the browsers' respective websites. CCPA Privacy Rights
              ...
              contact us. GDPR Data Protection Rights We would like to make sure
              you are fully aware of all of your data protection rights. Every
              user is entitled to the following: The right to access – You have
              ...
              like to exercise any of these rights, please contact us Changes to
              the privacy policy Code Genius may make changes to this privacy
              policy at any time by giving a notice on the website and/or by
              other applicable means. The data subjects are highly recommended
              to review the privacy policy on our website every now and then. If
              the data subject objects to any of the changes to this privacy
              policy, the data subject should cease using the services, where
              applicable, and they can request that we remove the personal data,
              unless applicable laws require us to retain such personal data.
              Unless stated otherwise, the then-current privacy policy applies
              to all personal data we process at the time.
            </p>
          </div>
          <Footer session={null} />
        </div>
