    ...
    <div className="relative h-screen w-full sm:ml-10">
      ...
      >
        <div className="w-full sm:mr-3">
          <div className="sm:text-1xl left-0 mx-auto mb-6 mt-8 w-full border-b-[1px] border-gray-400 px-2 py-4 pb-3 text-center font-sans text-[13px] uppercase text-purple-300 sm:mr-8 sm:mt-2 sm:ml-0 sm:pt-2 sm:text-left">
            {getCodeGeniusMode()}
          </div>
